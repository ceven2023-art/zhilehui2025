...
correctAnswer: 1,
explanation: '霜层像保温层一样阻碍冷气循环，会让压缩机更费电，制冷效果变差。'
},
{
question: '电饭煲煮饭结束后为什么要焖几分钟？',
options: [
'A. 让米饭内部水分重新均匀',
'B. 降低电饭煲温度',
'C. 方便盛饭',
...
correctAnswer: 0,
explanation: '焖饭时蒸汽在锅内循环，可让米饭内部水分回流，口感更软糯均匀。'
},
{
question: '电动牙刷刷头建议多久更换一次？',
options: [
'A. 每月一次',
'B. 大约三个月',
'C. 半年一次',
...
correctAnswer: 1,
explanation: '刷头使用约三个月后刷毛会磨损、变形，清洁力下降还容易滋生细菌。'
},
{
question: '为什么不建议边充电边玩手机？',
options: [
'A. 会影响信号',
'B. 容易导致电池过热和损伤',
'C. 会导致屏幕老化',
...
correctAnswer: 1,
explanation: '充电与高功耗同时进行会让电池长期处于高温状态，增加安全风险并加速老化。'
},
{
question: '食品包装上的"净含量"指的是什么？',
options: [
'A. 产品本身除去包装的实际重量或体积',
'B. 包装盒的重量',
'C. 产品加包装的总重量',
...
correctAnswer: 0,
explanation: '净含量指消费者真正买到的食品量，不包含外包装等其他部分。'
},
{
question: '日常家用的消毒酒精最佳浓度是多少？',
options: [
'A. 40%',
'B. 75%',
'C. 95%',
...
correctAnswer: 1,
explanation: '75%的乙醇浓度能更有效破坏细菌、病毒的蛋白质结构，达到最佳消毒效果。'
},
{
question: '为什么切开的水果要尽快冷藏或食用？',
options: [
'A. 让颜色更鲜艳',
'B. 切面易被细菌污染并加速氧化',
'C. 让水果变甜',
...
correctAnswer: 1,
explanation: '切开后细胞暴露在空气中，细菌易附着并且氧化速度加快，放置越久越容易变质。'
},
{
question: '炖汤前先将骨头焯水的主要目的是？',
options: [
'A. 让汤更白',
'B. 去除血沫和杂质，减少腥味',
'C. 增加钙质',
...
correctAnswer: 1,
explanation: '焯水能把骨头表面的血沫、浮油和杂质煮出，让汤更清亮少腥味。'
},
{
question: '厨房里放置干燥剂的主要作用是？',
options: [
'A. 装饰环境',
'B. 吸收油烟',
'C. 吸湿防霉防止食材受潮',
...
correctAnswer: 2,
explanation: '干燥剂可以吸附空气中的水分，防止食材和调味料受潮结块或发霉。'
},
{
question: '衣物烘干后为什么要及时取出？',
options: [
'A. 让烘干机更省电',
'B. 避免衣物闷在高温潮湿环境中发皱或发霉',
'C. 让衣物更香',
'D. 防止缩水'
],
correctAnswer: 1,
explanation: '烘干结束后衣物留在机内会吸潮返潮，容易起皱甚至滋生细菌。'
},
{
question: '洗蔬菜时采用流动清水冲洗的好处是什么？',
options: [
'A. 节约用水',
'B. 更有效带走泥沙和农药残留',
'C. 让蔬菜更翠绿',
...
correctAnswer: 1,
explanation: '持续流动的水能把表面的泥沙、农残冲走，比在水盆中浸泡更卫生。'
},
{
question: '瓶装水开封后为什么要尽快喝完？',
options: [
'A. 否则会变咸',
'B. 与空气接触后易滋生细菌',
'C. 会产生沉淀物',
...
correctAnswer: 1,
explanation: '开封后外界微生物容易进入瓶内，放置时间越长细菌越多，口感和安全性都会下降。'
},
{
question: '家庭常用灭火器优先选择哪种类型比较全面？',
options: [
'A. 水基灭火器',
'B. 泡沫灭火器',
'C. ABC干粉灭火器',
...
correctAnswer: 2,
explanation: 'ABC干粉灭火器适用范围广，可扑灭固体、液体和气体初起火灾，适合家庭常备。'
},
{
question: '为什么蜂蜜不宜用开水冲泡？',
options: [
'A. 会产生苦味',
'B. 高温会破坏蜂蜜中的活性酶和营养物质',
'C. 会变得更粘稠',
...
correctAnswer: 1,
explanation: '蜂蜜中的活性成分对热敏感，开水冲泡会让营养和风味大打折扣。'
},
{
question: '雨伞使用后要撑开晾干的原因是？',
options: [
'A. 方便收纳',
'B. 防止伞面残留水分导致发霉生锈',
'C. 让伞骨更牢固',
...
correctAnswer: 1,
explanation: '伞布和伞骨长期潮湿会霉变生锈，撑开晾干能延长使用寿命。'
},
{
question: '为什么床上用品要定期拿到阳光下晾晒？',
options: [
'A. 让颜色变淡',
'B. 阳光能杀菌除螨并去除潮气',
'C. 防止缩水',
...
correctAnswer: 1,
explanation: '紫外线有杀菌作用，晒被子还能驱散潮气，保持床品干爽卫生。'
},
{
question: '给手机充电最好使用原装或认证充电器的原因是？',
options: [
'A. 充电更快',
'B. 电压电流稳定，减少安全隐患',
'C. 更省电费',
...
correctAnswer: 1,
explanation: '未经认证的充电器输出不稳定，可能损伤电池甚至带来安全风险。'
},
{
question: '为什么冰箱不宜塞得过满？',
options: [
'A. 影响灯光亮度',
'B. 阻碍冷气循环，降低制冷效果',
'C. 占用插座',
...
correctAnswer: 1,
explanation: '冰箱需要空气循环带走热量，塞得太满会导致制冷不均匀并增加耗电。'
},
{
question: '新买的不锈钢锅首次使用前为什么要开锅？',
options: [
'A. 让锅更亮',
'B. 去除表面保护油和杂质，减少异味',
'C. 防止锅变形',
...
correctAnswer: 1,
explanation: '开锅可洗去出厂时残留的油污和金属屑，让后续烹饪更安全卫生。'
},
{
question: '夏天汽车内不应存放打火机的主要原因是？',
options: [
'A. 会被偷',
'B. 高温膨胀可能导致爆炸或泄漏',
'C. 会影响驾驶',
...
correctAnswer: 1,
explanation: '密闭车厢温度可快速升高，易燃易爆物品在高温下有爆炸风险。'
},
{
question: '洗衣机内桶为什么要定期清洗？',
options: [
'A. 让机器更安静',
'B. 长期潮湿易滋生细菌和污垢',
'C. 使容量变大',
...
correctAnswer: 1,
explanation: '内桶残留的洗涤剂和纤维会滋生细菌，定期清洗能保持卫生。'
},
{
question: '使用燃气热水器或燃气灶时保持通风的原因是？',
options: [
'A. 让火焰更漂亮',
'B. 防止一氧化碳聚集造成中毒',
'C. 节约燃气',
...
correctAnswer: 1,
explanation: '燃气不完全燃烧会产生一氧化碳，保持通风能稀释有害气体，确保安全。'
},
{
question: '为什么插排不应长期超负荷使用？',
options: [
'A. 会让灯更暗',
'B. 容易导致线路发热甚至引发火灾',
'C. 会增加噪音',
...
correctAnswer: 1,
explanation: '超过额定功率会让插排长期处于高温状态，绝缘老化风险大幅增加。'
},
{
question: '食盐为什么要密封保存？',
options: [
...
correctAnswer: 1,
explanation: '盐易吸湿结块，密封储存能保持干燥，使用时更方便。'
},
{
question: '玻璃瓶装饮料为何不宜直接放入冷冻室？',
options: [
'A. 会变淡',
'B. 液体冻结体积膨胀可能导致玻璃炸裂',
'C. 会失去气泡',
...
correctAnswer: 1,
explanation: '水结冰体积增大，密封玻璃难以扩张，易导致瓶身破裂产生危险。'
},
{
question: '一次性医用口罩为何建议累计使用不超过4小时？',
options: [
'A. 时间长会变色',
'B. 过滤材料吸附饱和后防护效果下降',
'C. 会产生异味',
...
correctAnswer: 1,
explanation: '口罩长时间佩戴会潮湿、聚集污染物，超过时限防护性能明显降低。'
},
{
question: '为什么厨房刀具清洗后要擦干再收纳？',
options: [
'A. 看起来更亮',
'B. 防止生锈并减少细菌滋生',
'C. 更容易找到',
...
correctAnswer: 1,
explanation: '刀具若带水收纳容易生锈发霉，擦干能保持锋利和卫生。'
},
{
question: '木筷子为什么需要定期更换？',
options: [
'A. 会变得太轻',
'B. 长期使用易出现裂缝滋生细菌',
'C. 会失去颜色',
...
correctAnswer: 1,
explanation: '木筷吸水性强，使用久了容易滋生细菌或霉斑，应定期更换。'
},
{
question: '为什么纸巾不宜随意丢进马桶？',
options: [
'A. 会增加清洁难度',
'B. 纸巾不易溶解，容易造成管道堵塞',
'C. 会产生异味',
...
correctAnswer: 1,
explanation: '纸巾纤维较长，不易分解，进入管道后容易堆积堵塞排水系统。'
},
{
question: '燃气灶点火失败后为什么要等待片刻再重新点火？',
options: [
'A. 让火花更强',
'B. 让未燃烧的燃气散去，避免积聚引发爆燃',
'C. 降低灶具温度',
'D. 节约燃气'
],
correctAnswer: 1,
explanation: '若立即重复点火，积聚的燃气可能瞬间燃爆，等待通风更安全。'
}
]
},
...

{
    ...
    questions: [
        ...
        },
        {
            ...
            correctAnswer: 1,
            explanation: '"冲浪"被网友用来形容在网络上四处逛、刷新闻和热梗的行为。'
        },
        {
            question: '"开麦"在直播或语音场景下意味着什么？',
            options: [
                'A. 开始唱歌',
                'B. 打开麦克风发言',
                'C. 切换频道',
            ...
            correctAnswer: 1,
            explanation: '"开麦"就是打开麦克风，说话或发出声音，常用于语音房、直播间。'
        },
        {
            question: '"双厨狂喜"通常描述什么情况？',
            options: [
                'A. 两位厨师比赛',
                'B. 两个圈子的粉丝同时开心',
                'C. 厨房促销活动',
            ...
            correctAnswer: 1,
            explanation: '"双厨狂喜"指两个不同兴趣圈的粉丝因同一内容而同时激动的场景。'
        },
        {
            question: '"爷青回"表达的情绪是什么？',
            options: [
                'A. 愤怒失望',
                'B. 童年记忆被唤起的感动',
                'C. 对长辈的敬意',
            ...
            correctAnswer: 1,
            explanation: '"爷青回"是"爷的青春又回来了"的缩写，用来表示某个旧事物回归带来的感动。'
        },
        {
            question: '"灵魂拷问"常用来形容什么？',
            options: [
                'A. 悬疑小说情节',
                'B. 直击内心的尖锐提问',
                'C. 心理测试',
            ...
            correctAnswer: 1,
            explanation: '"灵魂拷问"指那些直击痛点、让人无从回答的犀利问题。'
        },
        {
            question: '"无语子"在网络上表示什么情绪？',
            options: [
                'A. 欣喜若狂',
                'B. 无语、吐槽',
                'C. 感动落泪',
            ...
            correctAnswer: 1,
            explanation: '"无语子"是"无语了"的俏皮说法，用来表达无奈或吐槽。'
        },
        {
            question: '"工具人"指的是怎样的人？',
            options: [
                'A. 制作工具的工匠',
                'B. 只被当作帮忙工具的人',
                'C. 游戏中的角色',
            ...
            correctAnswer: 1,
            explanation: '"工具人"形容在关系中只被需要时才被想起、更多在付出的角色。'
        },
        {
            question: '"尾款人"通常出现在什么情境？',
            options: [
                'A. 直播下单',
                'B. 预售付定金后等待补尾款',
                'C. 网购退货',
            ...
            correctAnswer: 1,
            explanation: '"尾款人"是预售活动中等待支付剩余货款的消费者的自嘲说法。'
        },
        {
            question: '"打工人"在网络语境中的含义是？',
            options: [
                'A. 企业老板',
                'B. 普通上班族的自我调侃',
                'C. 临时工',
            ...
            correctAnswer: 1,
            explanation: '"打工人"是上班族用来自嘲的称呼，表达努力工作的无奈和坚持。'
        },
        {
            question: '"社牛"指什么样的人？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"社牛"是"社交牛逼"的缩写，形容非常外向、勇于社交的人。'
        },
        {
            question: '"社恐"在网络上常用来描述？',
            options: [
                'A. 恐惧社会新闻',
                'B. 在社交场合感到紧张不安的人',
                'C. 害怕社团活动',
            ...
            correctAnswer: 1,
            explanation: '"社恐"是社交恐惧的简称，指在社交场景会感到焦虑或害羞的人。'
        },
        {
            question: '"冲鸭"通常用来表达什么？',
            options: [
                'A. 烹饪鸭子的方式',
                'B. 鼓劲加油、一起冲',
                'C. 游戏角色技能',
            ...
            correctAnswer: 1,
            explanation: '"冲鸭"是"冲呀"的谐音，用来给自己或他人打气，相当于"加油"。'
        },
        {
            question: '"闭眼入"是什么意思？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"闭眼入"表示对某物非常信任，甚至闭着眼睛都愿意下单购买。'
        },
        {
            question: '"云玩家"指的是什么人？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"云玩家"指只看游戏实况、攻略视频，不亲自上手玩游戏的观众。'
        },
        {
            question: '"互联网嘴替"常用来形容谁？',
            options: [
                'A. 网络黑客',
                'B. 说出网友心声的人',
                'C. 网络主播',
            ...
            correctAnswer: 1,
            explanation: '"互联网嘴替"指那些能替网友发声、表达共同观点的人或发言。'
        },
        {
            question: '"小作文"在网络上通常指？',
            options: [
                'A. 小学生作文比赛',
                'B. 社交平台上长篇的情绪化文字',
                'C. 短篇小说',
            ...
            correctAnswer: 1,
            explanation: '"小作文"指网友写的情绪充沛、篇幅较长的文字，用来表达观点或控诉。'
        },
        {
            question: '"拉跨"是什么意思？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"拉跨"是网络俚语，形容表现不如预期、让人失望。'
        },
        {
            question: '"整活"通常描述什么行为？',
            options: [
                'A. 正经工作',
                'B. 搞怪、制造话题或娱乐效果',
                'C. 装修房屋',
            ...
            correctAnswer: 1,
            explanation: '"整活"指用创意或搞笑方式制造效果，常见于短视频或直播内容。'
        },
        {
            question: '"DNA动了"表达的感受是？',
            options: [
                'A. 遗传病发作',
                'B. 被熟悉元素激发的兴奋和共鸣',
                'C. 基因测试异常',
            ...
            correctAnswer: 1,
            explanation: '"DNA动了"表示遇到熟悉事物引发的强烈共鸣与激动。'
        },
        {
            question: '"梦回XX"中的"XX"一般表示什么？',
            options: [
                'A. 做梦的地点',
                'B. 某个年代或经典作品',
                'C. 游戏地图',
            ...
            correctAnswer: 1,
            explanation: '"梦回XX"用来形容某个场景让人仿佛回到某个年代或经典记忆中。'
        },
        {
            question: '"破圈"意味着什么？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"破圈"指作品或人气从小众圈层走向大众，引发更广泛关注。'
        },
        {
            question: '"生草"在二次元圈中表示什么？',
            options: [
                'A. 种植植物',
                'B. 某件事非常好笑',
                'C. 生长迅速',
            ...
            correctAnswer: 1,
            explanation: '"生草"来源于日语发音，表示被某件事逗笑，笑得在地上"长草"。'
        },
        {
            question: '"开摆"意味着什么态度？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"开摆"是年轻人自嘲用语，表示不再强求、索性躺平或摆烂。'
        },
        {
            question: '"糊弄学"是什么？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"糊弄学"是网友创造的词，指用最低成本敷衍完成任务的生活哲学。'
        },
        {
            question: '"xswl"是哪个短语的缩写？',
            options: [
                'A. 笑死我了',
                'B. 上午洗脸',
                'C. 休息无聊',
            ...
            correctAnswer: 0,
            explanation: '"xswl"是"笑死我了"的拼音首字母缩写，用来表达大笑。'
        },
        {
            question: '"磕CP"中的"磕"是什么意思？',
            options: [
                'A. 磕头拜访',
                'B. 追随并喜爱某对角色或真人组合',
                'C. 受到打击',
            ...
            correctAnswer: 1,
            explanation: '"磕CP"指喜欢并沉迷于某一对角色或真人情侣的互动和故事。'
        },
        {
            question: '"空降"在社交媒体评论区常表示？',
            options: [
                'A. 航空降落',
                'B. 直接跳到最新内容评论',
                'C. 退出讨论',
            ...
            correctAnswer: 1,
            explanation: '"空降"指不看前因后果，直接来到评论区或最新动态发表言论。'
        },
        {
            question: '"卡点"在网络语境通常指？',
            options: [
                'A. 交通堵点',
                'B. 在特定时间点发布内容',
                'C. 游戏卡顿',
            ...
            correctAnswer: 1,
            explanation: '"卡点"指精确选择某个时间节点发动态或做事，常用在倒计时场景。'
        },
        {
            question: '"反差感"用来形容什么？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"反差感"指某人或事物呈现出与外表预期完全不同的特质，让人惊讶。'
        },
        {
            question: '"热搜体质"通常指谁？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '"热搜体质"指总能因为各种事件频繁登上热搜榜的明星或话题人物。'
        }
    ]
},
...

{
    ...
    questions: [
        ...
        },
        {
            ...
            correctAnswer: 1,
            explanation: '雌蜻蜓会让腹部触碰水面，将卵产在水里或水生植物上，幼虫可以在水中成长。'
        },
        {
            question: '为什么小狗会伸出舌头喘气？',
            options: [
                'A. 表示开心',
                'B. 通过舌头蒸发散热',
                'C. 和主人交流',
            ...
            correctAnswer: 1,
            explanation: '狗的汗腺很少，张口伸舌让唾液蒸发能快速带走体内热量，是重要的散热方式。'
        },
        {
            question: '为什么猫咪的瞳孔会随光线大小变化？',
            options: [
                'A. 仅为防晒',
                'B. 调节进入眼睛的光量',
                'C. 帮助听觉',
            ...
            correctAnswer: 1,
            explanation: '猫的瞳孔能在强光时缩小、弱光时放大，以控制进入眼睛的光线，提高夜视能力。'
        },
        {
            question: '夜晚看到的流星其实是什么？',
            options: [
                'A. 会发光的鸟',
                'B. 小天体闯入大气烧蚀',
                'C. 恒星爆炸',
            ...
            correctAnswer: 1,
            explanation: '流星是微小陨石闯入地球大气层，与空气摩擦后发光燃烧产生的光迹。'
        },
        {
            question: '为什么大雾天气能见度会降低？',
            options: [
                'A. 空气湿度低',
                'B. 水滴散射光线',
                'C. 地面升温',
            ...
            correctAnswer: 1,
            explanation: '雾由大量悬浮的小水滴组成，会把光线向各个方向散射，使远处景物模糊。'
        },
        {
            question: '人的声音为什么会有高低之分？',
            options: [
                'A. 口腔大小不同',
                'B. 声带振动频率不同',
                'C. 牙齿数量不同',
            ...
            correctAnswer: 1,
            explanation: '声音的高低主要由声带振动频率决定，频率越高声音越尖，频率越低声音越沉。'
        },
        {
            question: '为什么肥皂泡会呈现七彩颜色？',
            options: [
                'A. 泡沫里有染料',
                'B. 薄膜产生光的干涉',
                'C. 光线发生折射',
            ...
            correctAnswer: 1,
            explanation: '肥皂泡膜厚度不一，入射光在内外表面反射形成干涉，叠加出绚丽的彩色条纹。'
        },
        {
            question: '乌龟遇到危险时为什么会缩进壳里？',
            options: [
                'A. 提高体温',
                'B. 保护柔软身体',
                'C. 储存水分',
            ...
            correctAnswer: 1,
            explanation: '龟壳是由骨骼和角质组成的坚硬护甲，缩壳能保护头和四肢免受天敌伤害。'
        },
        {
            question: '蝙蝠为什么喜欢倒挂着睡觉？',
            options: [
                'A. 欣赏夜景',
                'B. 方便随时起飞',
                'C. 增强血液循环',
            ...
            correctAnswer: 1,
            explanation: '蝙蝠后肢适合倒挂，倒挂时起飞只需松爪即可下落助力，省力又安全。'
        },
        {
            question: '傍晚的天空为什么常常变成橘红色？',
            options: [
                'A. 太阳颜色改变',
                'B. 光线传播路径更长导致散射',
                'C. 大气温度骤降',
            ...
            correctAnswer: 1,
            explanation: '傍晚阳光斜射，大气层路径变长，短波蓝光被散射掉，剩下波长较长的红橙光。'
        },
        {
            question: '雨后空气中闻到的泥土清香来自哪里？',
            options: [
                'A. 花草释放香味',
                'B. 土壤微生物产生的气味分子',
                'C. 雨水的味道',
            ...
            correctAnswer: 1,
            explanation: '雨滴击打土壤会释放出放线菌产生的土腥素（Geosmin），带来独特的泥土芳香。'
        },
        {
            question: '海浪拍打岸边时为什么会有大量泡沫？',
            options: [
                'A. 海水被加热',
                'B. 海水裹挟空气形成气泡',
                'C. 海底喷发气体',
            ...
            correctAnswer: 1,
            explanation: '波浪把空气带入水中，加上海水中含有蛋白质等表面活性物质，气泡不易破裂形成泡沫。'
        },
        {
            question: '向日葵为什么总是朝着太阳方向？',
            options: [
                'A. 太阳引力吸引',
                'B. 生长激素受光调节',
                'C. 喜欢高温',
            ...
            correctAnswer: 1,
            explanation: '向日葵茎部的生长素受光分布不均，背光侧生长更快，使花盘朝向阳光。'
        },
        {
            question: '为什么我们觉得月亮总跟着自己走？',
            options: [
                'A. 月亮速度和人一致',
                'B. 视觉错觉与视差小',
                'C. 月亮直视我们',
            ...
            correctAnswer: 1,
            explanation: '月亮距离地球极远，从不同位置观察视差很小，大脑缺乏参照物因而产生“跟着我走”的感觉。'
        },
        {
            question: '在雪地行走时为什么会听到“咯吱”声？',
            options: [
                'A. 冰晶被压碎',
                'B. 鞋底弹簧作响',
                'C. 空气振动',
            ...
            correctAnswer: 0,
            explanation: '踩雪时会压碎坚硬的雪晶粒，破裂和摩擦产生特有的“咯吱”声音。'
        },
        {
            question: '夏日的雷阵雨为什么来得快也走得快？',
            options: [
                'A. 云朵容量小',
                'B. 对流天气发展迅速',
                'C. 风向突然改变',
            ...
            correctAnswer: 1,
            explanation: '午后地表受热形成强烈对流，积雨云迅速发展并释放降水，能量耗尽后也会很快消散。'
        },
        {
            question: '为什么带静电的梳子能吸起纸屑？',
            options: [
                'A. 梳子表面黏',
                'B. 异性电荷相互吸引',
                'C. 梳子变得有磁性',
            ...
            correctAnswer: 1,
            explanation: '梳子与头发摩擦带电，会在纸屑上感应出异性电荷，静电力把纸屑吸附起来。'
        },
        {
            question: '人为什么会突然打嗝？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '打嗝是膈肌突然痉挛导致空气快速吸入，再被声门关闭发出“嗝”的声音。'
        },
        {
            question: '为什么鼻子常感觉一边通一边堵？',
            options: [
                'A. 感冒前兆',
                'B. 鼻腔自然交替充血',
                'C. 呼吸方式错误',
            ...
            correctAnswer: 1,
            explanation: '人体存在“鼻周期”，左右鼻腔的血管会交替充血与消退，因此常感觉一侧更通畅。'
        },
        {
            question: '为什么睡醒后眼角会有分泌物？',
            options: [
                'A. 睡眠太久',
                'B. 泪液和角质混合干燥',
                'C. 没有洗脸',
            ...
            correctAnswer: 1,
            explanation: '睡觉时泪液、眼睑腺体分泌物和脱落细胞会在眼角聚集，干燥后形成“眼屎”。'
        },
        {
            question: '手指长时间泡水为什么会起皱？',
            options: [
                'A. 皮肤吸水膨胀',
                'B. 神经调节血管收缩',
                'C. 角质层脱落',
            ...
            correctAnswer: 1,
            explanation: '研究显示指端起皱与交感神经控制血管收缩有关，可在湿润环境下提升抓握能力。'
        },
        {
            question: '喝冷饮时牙齿突然酸痛是为什么？',
            options: [
                'A. 冷饮太甜',
                'B. 牙本质小管受刺激',
                'C. 舌头过敏',
            ...
            correctAnswer: 1,
            explanation: '牙釉质下的牙本质有细小管道，温度骤变会刺激牙神经，引起一阵酸痛。'
        },
        {
            question: '吃甜食后心情为什么容易变好？',
            options: [
                'A. 血糖升高刺激大脑奖励系统',
                'B. 胃部更轻松',
                'C. 咀嚼动作让人开心',
            ...
            correctAnswer: 0,
            explanation: '糖分进入体内会提升血糖，促使大脑释放多巴胺等“快乐”神经递质，让人心情愉悦。'
        },
        {
            question: '竹子为什么生长得特别快？',
            options: [
                'A. 根系浅',
                'B. 节间细胞迅速伸长',
                'C. 竹子会自我复制',
            ...
            correctAnswer: 1,
            explanation: '竹秆的节间细胞在短时间内大量吸水伸长，加上充足的营养储备，造成极速生长。'
        },
        {
            question: '玉米变成爆米花需要什么条件？',
            options: [
                'A. 高盐环境',
                'B. 内部水分受热变成蒸汽',
                'C. 强光照射',
            ...
            correctAnswer: 1,
            explanation: '爆米花玉米粒含有少量水分，被加热时蒸汽把硬壳顶开，淀粉膨胀成松脆形态。'
        },
        {
            question: '风车为什么会转动？',
            options: [
            ...
            correctAnswer: 1,
            explanation: '风吹过风车叶片时，叶片受力不平衡产生转矩，从而带动风车旋转。'
        },
        {
            question: '热气球能够升空的原理是什么？',
            options: [
                'A. 气球质量很轻',
                'B. 热空气密度减小产生浮力',
                'C. 使用了磁力',
            ...
            correctAnswer: 1,
            explanation: '加热后的空气密度小于周围冷空气，气球获得向上的浮力而升空。'
        },
        {
            question: '地震来临前有些动物会异常躁动的原因是？',
            options: [
                'A. 早知道新闻',
                'B. 对细微震动和声波更敏感',
                'C. 与天气有关',
            ...
            correctAnswer: 1,
            explanation: '许多动物对低频震动、电磁变化更敏感，可能比人类更早感知到地壳异常。'
        },
        {
            question: '人的指纹为什么终生不变？',
            options: [
                'A. 会不断再生',
                'B. 真皮乳突结构固定',
                'C. 皮肤厚度不变',
            ...
            correctAnswer: 1,
            explanation: '指纹由真皮和表皮共同形成，真皮乳突的排列早在胎儿期确定，一生都保持稳定。'
        },
        {
            question: '为什么低沉的钟声能传得很远？',
            options: [
                'A. 钟体特别大',
                'B. 低频声波衰减慢',
                'C. 铃锤敲得用力',
            ...
            correctAnswer: 1,
            explanation: '低频声波波长长、绕射能力强，在空气中传播时能量衰减较慢，因此更容易传得远。'
        }
    ]
}
